...
CREATE TABLE "public"."Event" (
    ...
    "bannerVertical" VARCHAR(255),
    "bannerHorizontal" VARCHAR(255),
    "bannerMain" VARCHAR(255),
    "churchId" TEXT NOT NULL,
    "addressId" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."UserPosition" ADD CONSTRAINT "UserPosition_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."UserPosition" ADD CONSTRAINT "UserPosition_positionId_fkey" FOREIGN KEY ("positionId") REFERENCES "public"."Position"("id") ON DELETE CASCADE ON UPDATE CASCADE;
