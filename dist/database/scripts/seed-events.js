...
async function seedEvents() {
    ...
    const eventsToCreate = [
        {
            ...
            description: 'Culto dominical com louvor, pregação e comunhão. Venha adorar ao Senhor conosco!',
            category: 'Culto',
            isPaid: false,
            price: null,
        ...
        },
        {
            ...
            description: 'Conferência especial para jovens com pregações, workshops e momentos de adoração. Tema: "Jovem, levante-se!"',
        ...
        },
        {
            ...
            description: 'Aulas da Escola Bíblica Dominical para todas as idades. Estudo bíblico sistemático e aprofundado.',
            category: 'Educação',
            isPaid: false,
            price: null,
        ...
        },
        {
            ...
            description: 'Ensaio do coral da igreja. Venha fazer parte do ministério de música!',
            category: 'Música',
            isPaid: false,
            price: null,
        ...
        },
        {
            ...
            description: 'Culto especial de oração e intercessão. Momento de buscar a presença de Deus.',
            category: 'Oração',
            isPaid: false,
            price: null,
    ...
    try {
        ...
        if (!existingChurch) {
            console.log('❌ Igreja não encontrada. Execute primeiro o seed de igrejas.');
            return;
        }
        let createdCount = 0;
        let existingCount = 0;
        for (const eventData of eventsToCreate) {
            ...
            if (existingEvent) {
                console.log(`⚠️  Evento '${eventData.name}' já existe no banco de dados`);
                existingCount++;
                continue;
            }
